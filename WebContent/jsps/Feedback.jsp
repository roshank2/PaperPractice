...
<body>
	...
	<form method = "post" action= "${pageContext.request.contextPath}/jsps/processFeedback.jsp">
		<label
				for="uemail"><b>Email-ID</b></label><sup>*</sup>
		<input type="text"
				 name="uemail" />
		<label
				for="fb"><b>Feedback</b></label><sup>*</sup><br/>
