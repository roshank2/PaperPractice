...
<body>
	...
	<div class="content links">
		<div class="topicList">
			<h2 style="text-align: center; margin-bottom: 48px;"><%=sectionName%></h2>
			<%
			...
			%>
			<b><%=i%>.&nbsp;</b> <a
				href="${pageContext.request.contextPath}/takeExam?section_id=<%=set.getInt("section_id")%>&topic_id=<%=set.getInt("topic_id")%>&topic_name=<%=set.getString("topic_Name")%>"><%=set.getString("topic_name")%></a><br />
			<%
				i++;
			%>
			<%
