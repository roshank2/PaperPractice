...
<body>
	<form class="addQuestion" method="post"
		action="${pageContext.request.contextPath}/jsps/processModifiedQuestion.jsp">
		<h1>
		...
		<table>
			<tr>
				<td>Question:</td>
				<td colspan="3"><textarea rows="4" cols="108" name="question"><%=set.getString("question")%></textarea></td>
			</tr>
			<tr>
				<td>Option 1:</td>
				<td><input type="text" name="option1"
					value="<%=set.getString("option1")%>" /></td>
				<td>Option 2:</td>
				<td><input type="text" name="option2"
					value="<%=set.getString("option2")%>" /></td>
			</tr>
			<tr>
				<td>Option 3:</td>
				<td><input type="text" name="option3"
					value="<%=set.getString("option3")%>" /></td>
				<td>Option 4:</td>
				<td><input type="text" name="option4"
					value="<%=set.getString("option4")%>" /></td>
			</tr>
			<tr>
				<td>Answer:</td>
				<td><input type="text" name="answer"
					value="<%=set.getInt("correct_ans")%>" /></td>
				<td>Solution:</td>
				<td rowspan="2"><textarea rows="7" cols="24" name="solution"><%=set.getString("solution")%></textarea></td>
			</tr>
			<tr>
				<td></td>
		...
		<input type="hidden" name="tid"
			...
			type="hidden" name="qid" value="<%=request.getParameter("ques_id")%>" />
	</form>
</body>
</html>